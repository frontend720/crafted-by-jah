  ...
  return (
    ...
    >
      ...
      <div>
        <MediaController>
          <ReactPlayer
            ...
            controls={false}
          />
          <MediaControlBar style={media_bar_visibility}>
            <MediaPlayButton />
            <MediaTimeRange />
        ...
        {image && image.length > 0 && (
          <Swiper pagination={{ clickable: true }}  modules={[Pagination, Thumbs]}>
      ...
      <div className="save-container" style={is_save_button_visible}>
        <label htmlFor="" style={{marginRight: 15}}>{save_text}</label>
        <button
          style={{
